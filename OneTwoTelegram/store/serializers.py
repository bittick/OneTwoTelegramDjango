...
class SizesSneakersSerializer(serializers.ModelSerializer):
    ...
    sneak_brand = serializers.CharField(source='sneaker.brand')

    class Meta:
        model = SizesSneakers
        fields = ('sneak_id', 'sneak_title', 'sneak_brand', 'sneak_price', 'sneak_description', 'size_34',
                  'size_35', 'size_36', 'size_37', 'size_38', 'size_39', 'size_40',
                  'size_41', 'size_42', 'size_43', 'size_44', 'size_45')
        # a = []
        # fields = [f.name for f in SizesSneakers._meta.get_fields()]
